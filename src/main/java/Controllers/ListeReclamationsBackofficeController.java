...
public class ListeReclamationsBackofficeController {
    ...
    public void initialize() {
        try {
            FXMLLoader reponsesLoader = new FXMLLoader(getClass().getResource("/javaproject/MesReponsesView.fxml"));
    ...
    private void handleResponse(Reclamation reclamation) {
        ...
        try {
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/javaproject/ResponseDialog.fxml"));
            ...
            User utilisateur = utilisateurService.getById(reclamation.getIdUtilisateur());
