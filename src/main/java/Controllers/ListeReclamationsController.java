...
public class ListeReclamationsController implements Initializable {
    ...
    @FXML
    private void handleBackofficeButton(ActionEvent event) throws IOException {
        try {
            ...
            showAlert(Alert.AlertType.ERROR, "Erreur", "Erreur lors du chargement du backoffice: " + e.getMessage());
            e.printStackTrace();
        }
    }
